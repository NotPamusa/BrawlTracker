...
export default function CalculatorSettings() {
  ...
  const [moneyEfficiency, setMoneyEfficiency] = useState("1");
  const [gemEfficiency, setGemEfficiency] = useState("1");

  const [isRankedPlayer, setIsRankedPlayer] = useState(false);
  const [esportsRewards, setEsportsRewards] = useState(false);
            ...
            <div className="p-6 pb-12 space-y-10 overflow-y-auto custom-scrollbar flex-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="chamfer-sm p-[1.5px] bg-white/10 focus-within:bg-[var(--brawl-cyan)] transition-colors">
                    <div className="chamfer-sm bg-black/60">
                      <select
                        value={dailyActivityDelta}
                        onChange={e => setDailyActivityDelta(e.target.value)}
              ...
              <section className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="chamfer-sm p-[1.5px] bg-white/10 focus-within:bg-[var(--brawl-cyan)] transition-colors">
                    <div className="chamfer-sm bg-black/60">
                      <select
                        value={moneyEfficiency}
                        onChange={e => setMoneyEfficiency(e.target.value)}
                        className="w-full bg-transparent p-3 text-white font-bold outline-none appearance-none"
                        style={{ backgroundImage: 'none' }}
                      >
                ...
                <div className="space-y-2">
                  ...
                  <div className="chamfer-sm p-[1.5px] bg-white/10 focus-within:bg-[var(--brawl-cyan)] transition-colors">
                    <div className="chamfer-sm bg-black/60">
                      <select
                        value={gemEfficiency}
                        onChange={e => setGemEfficiency(e.target.value)}
                        className="w-full bg-transparent p-3 text-white font-bold outline-none appearance-none"
                        style={{ backgroundImage: 'none' }}
                      >
              ...
              <section className="space-y-6 pt-4 border-t border-white/5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <label className="flex items-center gap-4 cursor-pointer group bg-black/20 p-4 rounded-lg border border-white/5 hover:border-purple-500/50 transition-all">
                    ...
                    <span className="text-sm font-black text-white uppercase tracking-normal">Play Ranked often?</span>
                  </label>

                  <label className="flex items-center gap-4 cursor-pointer group bg-black/20 p-4 rounded-lg border border-white/5 hover:border-yellow-500/50 transition-all">
